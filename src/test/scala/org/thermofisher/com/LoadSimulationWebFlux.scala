...
class LoadSimulationWebFlux extends Simulation {

  val baseUrl = "http://xiao.thermofisher.com/"
  val testPath = "api/magellan/chat/webflux/agents?country=us&language=en&containerURI=/antibody/product/SERCA2-ATPase-Antibody-clone-2A7-A1-Monoclonal/MA3-919&version=f6163d4ecdc8c56f990c"
